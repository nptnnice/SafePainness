        ...
        <Flex sx={infoBox}>
          <Box>
            ...
            <Flex sx={textBox}>
              ...
              <Text>
                <chakra.span sx={mediumText}>Sex: </chakra.span>
                <chakra.span sx={regularText}>Male</chakra.span>
              </Text>
              <Text>
                <chakra.span sx={mediumText}>Blood Group: </chakra.span>
                <chakra.span sx={regularText}>B</chakra.span>
              </Text>
            </Flex>
          </Box>
          <Box>
