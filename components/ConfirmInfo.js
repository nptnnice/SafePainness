...
export default () => {
  ...
  return (
    <>
      <Text sx={GlobalStyle.headingText} marginTop="40px" marginLeft="280px">
        Contact Information
      </Text>
      <SimpleGrid columns={2} marginLeft="319px">
        <Box>
          <FormControl isRequired>
            <FormLabel marginTop="20px" width="80%" sx={GlobalStyle.normalText}>
              Phone
            </FormLabel>
        ...
        <Box>
          <Text marginTop="20px" width="80%" sx={GlobalStyle.normalText}>
            Email(Optional)
          </Text>
      ...
      <SimpleGrid
        ...
        marginBottom="13px"
      >
        <Button width="20%" marginLeft="650px" sx={whiteBtn}>
          Cancel
        </Button>
        <Button width="20%" marginLeft="300px" sx={blueBtn}>
          Create
        </Button>
      </SimpleGrid>
    </>
