...
export default function DoctorProfile(props) {
  ...
  const [form, setForm] = useState({
    doctorID: props.doctorInfo.doctorID,
    roleID: props.doctorInfo.roleID,
    firstName: props.doctorInfo.firstName,
    lastName: props.doctorInfo.lastName,
    birthDate: props.doctorInfo.birthDate,
    citizenID: props.doctorInfo.citizenID,
    licenseNO: props.doctorInfo.licenseNO,
    phoneNumber: props.doctorInfo.phoneNumber,
    username: props.doctorInfo.username,
    password: props.doctorInfo.password,
    email: props.doctorInfo.email,
    department: props.doctorInfo.department,
    image: props.doctorInfo.image,
  })
